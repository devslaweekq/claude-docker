...
Both are orchestrated together from the root [`docker-compose.yml`](docker-compose.yml) / [`docker-compose.dev.yml`](docker-compose.dev.yml) and started via [`claude-docker/launcher`](claude-docker/launcher).
